...
function Temp() {
  ...
  const genres = [
    ...
    },
    {
      ...
      name: "Water",
      icon: waterIcon,
      gradientFrom: "rgba(19, 97, 153, 0.9)", // 70% visible (better depth)
  ...
  return (
    <div className="text-white px-4 sm:px-8 md:px-16 lg:px-32 2xl:px-48 py-6 sm:py-10">
      {/* Top Menu Bar */}
      ...
      <div className="text-center">
        <motion.h1
          ...
          animate="visible"
          exit={{ opacity: 0 }}
          className="text-center py-2 sm:py-4 2xl:py-8 px-4 sm:px-24 text-3xl 2xl:text-4xl"
        >
        ...
        {animating && (
          <p className="mt-2 text-blue-400">Selecting your element...</p>
        )}
      </div>

      <div className="clubbody flex flex-col">
